...
@Component({
  selector: 'jobs-material-checkbox',
  templateUrl: './jobs-material-checkbox.component.html',
  styleUrls: ['./jobs-material-checkbox.component.css']
})
export class JobsMaterialCheckboxComponent implements OnInit {
