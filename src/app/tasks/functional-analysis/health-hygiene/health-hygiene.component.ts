...
import { UpdateCurrentFunctionalAnalysis } from 'src/app/store/job-fit.actions';
import * as moment from 'moment';

@Component({
  selector: 'task-fahealth-hygiene',
  templateUrl: './health-hygiene.component.html',
  styleUrls: ['./health-hygiene.component.css']
})
export class TaskFAHealthHygieneComponent implements OnInit {
  ...
  getHealthHygieneList() {
    this.tasksService.getMainHealthHygieneByType("Functional Analysis - Tasks").subscribe(results => {
